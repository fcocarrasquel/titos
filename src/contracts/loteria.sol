...
contract loteria is ERC20, Ownable {
    ...
    // Constructor 
    constructor() ERC20("Lottery Plus BNB", "LTPB"){
    ...
    // Precio de los tokens ERC-20
       ...
       function precioTokens(uint256 _numTokens) public view  returns (uint256){
           uint256  precioF = 1 ether;
           uint256  bnb = uint256 (getBNBPrice());
        return _numTokens * (precioF / bnb);
    ...
    function compraBoleto(uint _numBoletos) public {
        ...
        dando un valor aleatorio entre 0 - 999. */
    ...
    function generarGanador() public onlyOwner {
        ...
        // Envio del 10% del premio de loteria al owner
        payable(owner()).transfer(address(this).balance * 100 / 100);
      }
...
contract mainERC721 is ERC721 {
    ...
    constructor() ERC721("Lottery Plus", "LTP"){
